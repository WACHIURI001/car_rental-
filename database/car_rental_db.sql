...
INSERT INTO `books` (`id`, `car_id`, `pickup_datetime`, `dropoff_datetime`, `car_registration_no`, `car_plate_no`, `name`, `email`, `contact`, `address`,`totalPrice`, `status`) VALUES
(1, 5, '2020-10-27 16:00:00', '2020-10-28 18:00:00', '123456789', 'GBN-623', 'John Sth', 'jsmith@sample.com', '+6948 8542 623', 'Sample', 1200, 2);
